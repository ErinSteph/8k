  ...
  qr.spawn = function(){
    ...
    qr.parseQuotes = function(){
      $.each($$('a'), function(c, i){
        ...
        }else if(setting.recent.indexOf(c.href.split('.html#')[1]) > 0 && $.att(c, 'You') != 'marked'){
          $.att(c, 'You', 'marked');
          var y = {};
          y['class'] = 'kqr-you';
    ...
    $.time(3000, qr.parseQuotes, true);
    
    //d.addEventListener('new_post', function(e, r){  
     //alert('post');
     // qr.parseQuotes();
    //}, false);
    
   //d.addEventListener('ajax_after_post', function(e, r){  
     //alert('you posted');
     // qr.parseQuotes();
    //}, false);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4) {
                ...
                if(re.hasOwnProperty('error')){                  
                  ...
                  $.time(2000, function(){ $.event('click', {}, $('#update_thread')); }, false);                 
                }
            }
        }
